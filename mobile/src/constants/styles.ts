...
const WITH_SUPERCAR_PHOTO_1 = { uri: 'https://pyziuothzjdijkvdryht.supabase.co/storage/v1/object/public/style-previews/with_supercar/preview.jpg' };
const COFFEE_SHOP_PHOTO_1 = { uri: 'https://pyziuothzjdijkvdryht.supabase.co/storage/v1/object/public/style-previews/coffee_shop/preview.jpg' };
const LUXURY_YACHT_PHOTO_1 = { uri: 'https://pyziuothzjdijkvdryht.supabase.co/storage/v1/object/public/style-previews/luxury_yacht/preview.jpg' };
...
export const STYLE_PRESETS: Record<string, StylePreset> = {
  ...
  with_supercar: {
    key: 'with_supercar',
    name: 'With Supercar',
    description: 'Glamorous lifestyle portrait with luxury supercar',
    thumbnail: WITH_SUPERCAR_PHOTO_1,
    thumbnails: [WITH_SUPERCAR_PHOTO_1],
  ...
  coffee_shop: {
    key: 'coffee_shop',
    name: 'Coffee Shop',
    description: 'Cozy coffee shop moment with warm, inviting atmosphere',
    thumbnail: COFFEE_SHOP_PHOTO_1,
    thumbnails: [COFFEE_SHOP_PHOTO_1],
  ...
  luxury_yacht: {
    key: 'luxury_yacht',
    name: 'Luxury Yacht',
    description: 'Elegant yacht lifestyle with ocean breeze and sophistication',
    thumbnail: LUXURY_YACHT_PHOTO_1,
    thumbnails: [LUXURY_YACHT_PHOTO_1],
  ...
  city_rooftop: {
    key: 'city_rooftop',
    name: 'City Rooftop',
    description: 'Urban sophistication on a stylish rooftop at dusk',
    thumbnail: CITY_ROOFTOP_PHOTO_1,
    thumbnails: [CITY_ROOFTOP_PHOTO_1],
  ...
  beach_sunset: {
    key: 'beach_sunset',
    name: 'Beach Sunset',
    description: 'Serene beach sunset with golden hour magic',
