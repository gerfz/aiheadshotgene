...
export function GeneratingScreen({ navigation }: Props) {
  const { selectedImage, selectedStyle, setIsGenerating, setCredits } = useAppStore();
  ...
  const startGeneration = async () => {
    ...
    try {
      ...
      if (result.success) {
        navigation.replace('Result', { generation: result.generation });
      } else {
